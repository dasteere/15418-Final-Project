...
static void get_ip_bet_action_lists_enum(hand_t *range, ip_action *strat, int n,
...
static void get_ip_check_action_lists_enum(hand_t *range, ip_action *strat, int n,
...
static void get_oop_action_lists_enum(hand_t *range, oop_action *strat, int n,
...
void output_human_readable_enum(hand_t *oopRange, oop_action *oopStrat, int oopSize,
        hand_t *ipRange, ip_action *ipCheckStrat, ip_action *ipBetStrat, 
        int ipSize) {
    int max = oopSize > ipSize ? oopSize : ipSize;
    ...
    get_oop_action_lists_enum(oopRange, oopStrat, oopSize, check_call, check_fold, bet,
            &num_check_call, &num_check_fold, &num_bet);
    ...
    get_ip_check_action_lists_enum(ipRange, ipCheckStrat, ipSize,
            check, bet, &num_check, &num_bet);
    get_ip_bet_action_lists_enum(ipRange, ipBetStrat, ipSize, call,
            fold, &num_call, &num_fold);
